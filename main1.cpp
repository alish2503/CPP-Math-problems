...
int main(void) { 
	...
	std::cout << std::endl << "Число итераций " << m << std::endl;
	std::cout << "Спектральный радиус " << rs << std::endl << std::endl;
	std::cout << std::setw(5) << std::left << "k"
		...
		<< std::setw(28) << std::right << "Оц-ка пог-сти"
	...
	std::cout << std::endl << duration.count() << " секунд" << std::endl;
